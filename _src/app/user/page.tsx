					...
					<div className="grid gap-2 sm:grid-cols-12 sm:gap-6">
						...
						<div className="sm:col-span-3">
							<div className="inline-block">
								<label
									form="af-account-phone"
									className="mt-2.5 inline-block text-sm text-gray-800 dark:text-gray-200"
								>
									Phone
								</label>
								<span className="text-sm text-gray-400 dark:text-gray-600">(Optional)</span>
							</div>
						</div>
						...
						<div className="sm:col-span-3">
							<label
								form="af-account-gender-checkbox"
								className="mt-2.5 inline-block text-sm text-gray-800 dark:text-gray-200"
							>
								Gender
							</label>
						...
						<div className="sm:col-span-9">
							<div className="sm:flex">
								...
								<label
									form="af-account-gender-checkbox-female"
									className="relative -ms-px -mt-px flex w-full border border-gray-200 px-3 py-2 text-sm shadow-sm first:rounded-t-lg last:rounded-b-lg focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 dark:focus:ring-gray-600 sm:mt-0 sm:first:ms-0 sm:first:rounded-s-lg sm:first:rounded-se-none sm:last:rounded-e-lg sm:last:rounded-es-none"
								>
									<input
										type="radio"
									...
									/>
									<span className="ms-3 text-sm text-gray-500 dark:text-gray-400">Female</span>
								</label>

								<label
									form="af-account-gender-checkbox-other"
									className="relative -ms-px -mt-px  flex w-full border border-gray-200 px-3 py-2 text-sm shadow-sm first:rounded-t-lg last:rounded-b-lg focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 dark:focus:ring-gray-600 sm:mt-0 sm:first:ms-0 sm:first:rounded-s-lg sm:first:rounded-se-none sm:last:rounded-e-lg sm:last:rounded-es-none"
								>
									<input
										type="radio"
									...
									/>
									<span className="ms-3 text-sm text-gray-500 dark:text-gray-400">Other</span>
								</label>
							</div>
						</div>
					</div>
